...
class RecommendProjectAdminController extends BasicController
{
    /**
     * @var RecommendProjectModel
     */
    protected $model;
    ...
    public function __construct($request, $response, $server = null)
    {
        ...
        $this->model = new RecommendProjectModel();
    }

    public function create(){
        v::arrayVal()
            ->key('country', v::in(ProjectModel::COUNTRY))
            ->key('type', v::arrayVal()->each(v::in(array_keys($this->model::TYPE))))
    ...
    public function update(){
        ...
        v::arrayVal()
            ...
            ->key('type', v::arrayVal()->each(v::in(array_keys($this->model::TYPE))),false)
    ...
    public function index(){
        v::arrayVal()
            ...
            ->key('country', v::in(ProjectModel::COUNTRY),false)
            ->key('type', v::in(array_keys($this->model::TYPE)),false)
            ->assert($this->get);
        ...
        $this->response->respond_data['type'] = $this->model::TYPE;
        return $this->ok();
    }
